#!/usr/bin/env python3
"""
Enhanced Brazilian E-Commerce Analysis Dashboard with Integrated Documentation
=============================================================================
...
Run with: python dashboard_with_docs.py
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.P("💡 All documentation integrated above in the Documentation tab", 
...
def display_document(filename):
    ...
    try:
        ...
        # For notebooks, display formatted content
...
if __name__ == '__main__':
    print("🚀 Starting Enhanced Brazilian E-Commerce Analysis Dashboard with Documentation...")
    ...
    print("   - 📚 Integrated Documentation Viewer")
